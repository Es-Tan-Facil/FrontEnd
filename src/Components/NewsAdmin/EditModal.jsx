    ...
    showModal && (
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 border-4 border-blue-500 max-w-lg w-full">
          <h2 className="text-2xl text-blue-500 font-bold mb-4">Edita tu post</h2>
          ...
          <form>
            ...
            <div className="flex justify-end">
              <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-1 px-2 rounded mr-2" onClick={handleSave}>Save</button>
