    ...
    <div className="max-w-md mx-auto bg-white border-4 border-[#51C8FC] shadow-md rounded px-8 pt-6 pb-8 mb-4 rounded-tl-none rounded-br-none rounded-tr-3xl rounded-bl-3xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <textarea onChange={(event) => { setDescription(event.target.value) }} value={description} rows={7} className="appearance-none border border-[#51C8FC] rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" required id="description" placeholder="Cuéntanos tu experiencia..." />
        </div>
        <div className="mb-4">
          <InputPhoto setUrlImg={setUrlImg} ref={inputPhotoRef} />
        </div>
        <div className="mb-4">
