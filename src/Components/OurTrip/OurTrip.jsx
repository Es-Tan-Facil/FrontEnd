...
import mapa from "../../Assets/Pictures/mapa.svg"
import './OurTrip.css'

export default function OurTrip() {
    return (
        <div id="containerTrip" class="flex justify-center items-center flex-row flex-wrap gap-20 py-4">
            <div id="textTrip" class="text-justify">
