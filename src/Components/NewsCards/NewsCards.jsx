...
console.info(data[0].title)
  return (
    <>
     {data.map((item) => 
    <div id="CardBorder" class="max-w-sm rounded overflow-hidden  border border-2git  border-solid rounded-tl-none rounded-br-none rounded-tr-3xl rounded-bl-3xl pb-10 ">
