...
const year = new Date(card.date).getFullYear();
  ...
  return (
    ...
    <div id="CardBorder" className="w-4/5 min-w-[70%] max-w-[70%] h-auto md:min-w-[23%] md:max-w-[23%] rounded overflow-hidden border-solid border-2 border-[#51C8FC] rounded-tl-none rounded-br-none rounded-tr-3xl rounded-bl-3xl pb-10 ">
      ...
      <h4 className="font-bold my-4 mx-4 h-15 md:text-[1.5rem] text-[#51C8FC] ">{card.title}</h4>
