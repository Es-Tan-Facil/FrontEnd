...
const year = new Date(card.date).getFullYear();
  ...
  return (
    ...
    <div id="CardBorder" className=" min-w-[70%] max-w-[70%] md:min-w-[25%] max-w-[25%] rounded overflow-hidden border border-solid border-2 border-[#51C8FC] rounded-tl-none rounded-br-none rounded-tr-3xl rounded-bl-3xl pb-10 ">
