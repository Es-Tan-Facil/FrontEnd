...
const Counter = () => {
  ...
  return (
    ...
    <div className="w-4/5 min-w-[70%] max-w-[70%] md:min-w-[23%] md:max-w-[23%] h-auto
    rounded overflow-hidden border-solid border-2 border-[#51C8FC] rounded-tl-none 
    rounded-br-none rounded-tr-3xl rounded-bl-3xl flex justify-center items-center flex-col ml-[65rem]">
